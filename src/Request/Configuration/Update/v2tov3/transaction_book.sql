...
ALTER TABLE `book`
  ...
  ADD CONSTRAINT `fk_book_creativeWork` FOREIGN KEY (`creativeWork`) REFERENCES `creativeWork` (`idcreativeWork`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_book_thing` FOREIGN KEY (`creativeWork`) REFERENCES `thing` (`idthing`) ON DELETE CASCADE;
