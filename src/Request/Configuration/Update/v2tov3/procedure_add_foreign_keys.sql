...
BEGIN
  ...
  -- OFFER
  ALTER TABLE `offer`
    ADD KEY `fk_offer_thing_idx` (`itemOffered`),
    ADD CONSTRAINT `fk_offer_thing` FOREIGN KEY (`itemOffered`) REFERENCES `thing` (`idthing`) ON DELETE CASCADE ON UPDATE NO ACTION;
  -- ORGANIZATION
