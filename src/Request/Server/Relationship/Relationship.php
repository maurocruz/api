...
namespace Plinct\Api\Request\Server\Relationship;
...
class Relationship extends RelationshipAbstract
{
	 ...
	 */
  public function __construct(string $tableHasPart, int $idHasPart, string $tableIsPartOf, int $idIsPartOf = null)
  {
